...
document.getElementById("btnExportarVentasExcel")?.addEventListener("click", () => {
  ...
  exportarExcelCaja([{ nombre: "Ventas", data, colsMoney: [5,6,8] }], `JPSoft_QBV_Ventas_${desde}.xlsx`);
...
document.getElementById("btnExportarCajaExcel")?.addEventListener("click", () => {
  ...
  exportarExcelCaja([{ nombre: "Caja", data, colsMoney: [4,6,7,8,9,10] }], `JPSoft_QBV_Caja_${desde}.xlsx`);
